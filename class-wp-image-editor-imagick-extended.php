<?php
/*
 * Based on wp-includes/class-wp-image-editor-imagick.php from
 * https://github.com/WordPress/WordPress/ licensed under
 * GPLv2 or later
 */

class WP_Image_Editor_Imagick_Options extends WP_Image_Editor
{
    /**
     * Imagick object.
     *
    ...
    {
        // Who cares about GIF or BMP? We don't live in 1995 any more
        switch ($mime_type) {
            case 'image/jpeg':
                return true;
            case 'image/png':
    ...
    public function resize($max_w, $max_h, $crop = false)
    {
        ...
        // Execute the resize.
        $thumb_result = $this->thumbnail_image($dst_w, $dst_h, $this->options['filter']);
